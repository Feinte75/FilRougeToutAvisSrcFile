...
public class SocialNetwork {
	...
	/**
	 * Permet de v�rifier que le pseudo est d'une longueur sup�rieure � 1 
	 */
	...
	/**
	 * Permet de v�rifier que le password est d'une longueur sup�rieure � 3 
	 */
	 ...
	 * @param password son mot de passe
	 * 
	 * @return boolean renvoie true ou false en fonction de l'existence du couple pseudo/password dans la base de donn�e Social Network
	 * 
	 */
